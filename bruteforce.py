...
if __name__ == '__main__':
    ...
    parser.add_argument('--coin', choices=['bitcoin', 'btc', 'dumbcoin', 'dmb'], default='dumbcoin', nargs='?',
                        help='Specify the coin network (bitcoin/btc or dumbcoin/dmb). Defaults to dumbcoin.')
